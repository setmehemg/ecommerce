...
<p class="white-text" style="font-weight:bold;"> 
    <a href="{{url('admin-products')}}" class="badge badge-pill btn-green   disabled px-3 py-2">  <i class="fas fa-file-powerpoint"></i>  &nbsp; Mostrar todos produtos</a> 
...
<div class="container py-5">
    <p align="left">
        <i class="fas fa-file-powerpoint"></i> Todos produtos
   </p>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="{{url('admin-product-edit/'.$item->id)}}" class="badge badge-pill btn-primary px-3 py-2">Editar</a>
                                <a href="{{url('admin-product-delete/'.$item->id)}}" class="badge badge-pill btn-danger px-3 py-2">Deletar</a>
