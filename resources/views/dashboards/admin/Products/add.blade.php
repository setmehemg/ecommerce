...
<div align="center" style="background:#1CD5E8;padding:20px;"> 
        ...
        <p class="white-text" style="font-weight:bold;"> 
            ...
            <a href="{{url('admin-add-product')}}" class="badge badge-pill btn-dark disabled  px-3 py-2">   <i class="fas fa-plus"></i>  &nbsp; Adicionar novo produto</a> 
                ...
                <div class="tab-content" id="myTabContent">
                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                      ...
                      <div class="row" style="padding: 30px;">
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                              <button type="submit" class="btaobtn btaobtn-success">Salvar</button>
                              </div>
                          </div>
                  ...
                  <div class="tab-pane fade" id="pstatus" role="tabpanel" aria-labelledby="pstatus-tab">
                      ...
                      <div class="row" style="padding:30px;">
                              ...
                              <div class="col-md-12">
                                  ...
                                  <p>
                                      PS: Se marcar, vai ser visível ao público.
                                  </p>
                              </div>
                              <div class="col-md-12">
                                <div class="form-group">
