                ...
                <div class="carousel-inner">
                      ...
                      <div class="carousel-item active">
                            ...
                            <div class="view overlay">
                              ...
                              <div align="left" class="col-md-5 p-5 mx-5">
                                  <h1 class="black-text animated fadeInLeft slow " style="font-size:40px;">Até 10% de desconto na primeira compra!
                                 </h1>
                                  <a href="{{url('Shop/Chess-Board')}}" target="_blank" class="btn btn-dark"  >Adquira Agora!</a>
                              </div>
                     ...
                     <div class="carousel-item">
                            <div class="view overlay">
                              <div class="row mx-5">
                              <div align="left" class="col-md-5 p-5 mx-5">
                                  <h1 class="black-text animated fadeInLeft slow " style="font-size:40px;">Peças prontas ou sobre encomenda!</h1>
                                 
                               <a href="{{url('Shop/Mat')}}" target="_blank" class="btn btn-dark"  >Adquira Já!</a>
                              </div>
                              <div class="col-md-3 animated fadeInRight slow">
                       ...
                       <div class="carousel-item">
                            ...
                            <br>
                                      <h1 class="black-text animated fadeInLeft slow " style="font-size:30px;">Tenha um estilo rústico em sua casa!</h1>
                                      <div class="container">
                                          <div class="row ">
                       ...
                       <div class="carousel-item">
                            <div class="view overlay">
                                 <div align="center" class="p-5 " style="margin-top:-20px;">
                                      ...
                                      <h1 class="black-text animated fadeInLeft slow " >A melhor qualidade na sua casa!</h1>
