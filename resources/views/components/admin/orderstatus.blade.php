            ...
            <!--Grid row-->
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-hover">
                                 <tr>
                                  ...
                                  <tr>
                                    <th><i class="fas fa-truck "></i>Status de entrega:</th>
                                    @if(session('Order_Cancel_Status')==1 || session('Delivery_Status') !='pending' )
                                    <td class="disabled" alt="Disaled">  
                                    @else 
                                    <td> 
                                  ...
                                  <tr>
                                    <th><i class="fas fa-rupee-sign "></i>Modo de pagamento:</th>
                                    <td> 
                ...
                <!--Grid row-->
                    ...
                    <ul align="left" style="color:red">
                          @if(session('Order_Cancel_Status')==1 )
                            <li>
                                 Não é possível atualizar o embarque e entrega devido ao cancelamento do pedido...
                            </li>
                            <li>Clique <a href="{{url('admin-Order-Re-Cancel/'.session('Order_id').'')}}" >Aqui</a> para cancelar esse pedido.</li>
                         @else
                                 <li>
                               Não é possível atualizar o status de entrega múltiplas vezes
                            </li>
                         @endif
