...
<!-- ======= Header ======= -->
    <header id="header" class="z-depth-1"  style="position:fixed;top:0px;width:100%;font-family: 'Balsamiq Sans', cursive;">
        <div class="container d-flex" >
          ...
          <div id="Rekrie_Logo" class="logo mr-auto" >
          ...
          <div class="col-md-4"  >
              <div class="input-group md-form form-sm  " style="width:100%;">
                <input class="form-control my-0 py-1 red-border searchstring" list="plists" name="plist" id="plist" type="text" placeholder="Procurar" aria-label="Search" >
                <datalist id="plists">
                    @php
          ...
          <nav class="nav-menu d-none d-lg-block contentfont" >
            ...
            <ul style="margin-top:5px;">
              ...
              <li><a href="{{url('Help')}}"><i class="fas fa-headset"  ></i>  Ajuda</a></li>   
             
                @if (Route::has('login'))

                @auth
                  <li class="drop-down"><a href="#">  <i class="far fa-user-circle "></i>Minha Conta<i class="fas fa-angle-down"></i></a> 
                       <ul>
                            <li><a href="{{url('dashboard')}}" ><i class="fas fa-tachometer-alt"></i>  Dashboard</a></li>
                            <li><a href="{{url('profile')}}" ><i class="fas fa-user"></i>  Perfil</a></li>
                            <li><a href="{{url('Orders')}}" > <i class="fas fa-table"></i> Pedidos</a></li>
                            <li><a href="{{url('Payments')}}" ><i class="fas fa-receipt"></i>  Transações</a></li>
